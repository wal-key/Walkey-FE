...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div
            className={`modal-overlay ${isVisible ? 'opacity-100' : 'opacity-0'}`}
        >
            {/* Backdrop */}
            <div
            ...
            {/* Modal Content */}
            <div
                className={`glass-panel modal-container ${isVisible ? 'scale-100' : 'scale-95'}`}
            >
                <button
                    onClick={onClose}
                ...
                <div className="modal-buttons">
                    {/* Naver Login */}
                    <button className="modal-btn btn-naver">
                        <img src={naverLogo} alt="Naver" width="20" height="20" />
                        <span>네이버로 시작하기</span>
                    </button>

                    {/* Kakao Login */}
                    <button className="modal-btn btn-kakao">
                    ...
                    {/* Google Login */}
                    <button className="modal-btn btn-google">
                    ...
                    {/* GitHub Login */}
                    <button className="modal-btn btn-github">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="modal-footer">
                    로그인함으로써 Walkey의
                    <a href="#" className="modal-link">이용약관</a>
                    및
